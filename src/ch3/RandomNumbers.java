...
public class RandomNumbers {
	...
	public static void main(String[] args) {
		...
		System.out.println("Zufallszahl zwischen 0 und 9: " + num1);
		num1 = random.nextInt(10) + 1;
		System.out.println("Zufallszahl zwischen 1 und 10: " + num1);
		num1 = random.nextInt(21) - 10;
		System.out.println("Zufallszahl zwischen -10 und 10: " + num1);
		num2 = random.nextFloat();
		System.out.println("Zufallszahl aus [0.0, 1.0[: " + num2);
		num2 = random.nextFloat() * 5;
		System.out.println("Zufallszahl aus [0.0, 5.0[: " + num2);
